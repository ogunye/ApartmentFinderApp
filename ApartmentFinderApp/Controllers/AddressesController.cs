...
namespace ApartmentFinderApp.Controllers
{
    public class AddressesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,BuildingNumber,StreetName,Area_locality,LandMark,City,Zip_PostalCode,State_Province")] Address address)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BuildingNumber,StreetName,Area_locality,LandMark,City,Zip_PostalCode,State_Province")] Address address)
        {
            if (id != address.Id)
            {
                return NotFound();
